...
flatpak update
curl -L -o goose.flatpak https://github.com/aaif-goose/goose/releases/download/v1.30.0/io.github.block.Goose_stable_x86_64.flatpak && flatpak install --user -y ./goose.flatpak; rm goose.flatpak
